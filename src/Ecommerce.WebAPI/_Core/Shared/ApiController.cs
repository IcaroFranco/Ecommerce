...
namespace Ecommerce.WebAPI._Core.Shared
{
    [ApiController]
    public class ApiController : ControllerBase
    {
        ...
        protected IActionResult ResponseBadRequest(object data) =>
            Response(HttpStatusCode.BadRequest, data);
        ...
        protected IActionResult ResponseNotFound() =>
            Response(HttpStatusCode.NotFound, errorMessage: "O rescurso não foi encontrado.");
        ...
        protected new JsonResult Response(HttpResponseHeader responseHeader) =>
